...
dataFillQueries = [
    ...
    +"\n    ('Nineteen Eighty-Four', 'george orwell','pictures/1984(2).jpg',"
    ...
    +"\n    ('The Plague', 'Albert Camus','pictures/the_plague(2).jpg',"
    ...
    +"\n    ('Mein Kampf', 'Adolf Hitler','pictures/mein_kampf.jpg',"
    +"\n    98400, 'Lorem ipsum dolor sit amet,"
    +"\n    diam summo duo ad'),"
    +"\n    ('The Sandman', 'Neil Gaiman','pictures/sandman.jpg',"
